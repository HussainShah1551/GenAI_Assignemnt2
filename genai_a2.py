...
llm_model = ChatFireworks(
    ...
    fireworks_api_key="fw_3ZTz64NwEr4zGhqt1neQyn7w",
    temperature=0.1,
)
...
user_question = input("\n\nPlease ask your question relating to Emumba policy: ")
...
def langchain_evaluator(query: str, response: str, context: str) : 

 evaluator = load_evaluator("criteria", llm=llm_model, criteria=Criteria.RELEVANCE)
 ...
 print ("\nLangchain Evaluator Results\n" )
 print ("\nDetailed Evaluation :", eval_result.get("reasoning"))
 print("\nRelevance Score:",eval_result.get("score"))
   


langchain_evaluator(query, response, combined_text) 
